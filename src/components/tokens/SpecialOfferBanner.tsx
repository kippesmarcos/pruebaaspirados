  ...
  return (
    <div className="relative mb-12">
      ...
      <motion.div 
        ...
        className="relative bg-gradient-to-r from-[#2D2D2D] to-[#1D1D1D] p-6 rounded-lg border-2 border-[#FFD700]/30"
      >
        ...
        <div className="relative flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="font-minecraft text-[#FFD700] text-xl mb-1">
              ¡Oferta especial!
            </h3>
          ...
          <motion.div
            ...
            className="text-[#FFD700] font-minecraft text-lg px-3 py-1.5 rounded bg-[#FFD700]/10 border border-[#FFD700]/20"
          >
            -50%
          </motion.div>
        </div>
